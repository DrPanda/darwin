<div class="students index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('comment_user'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($student['Student']['session_id']); ?>&nbsp;</td>
		...
		<td><?php echo h($student['Student']['comment']); ?>&nbsp;</td>
		<td><?php echo h($student['Student']['comment_user']); ?>&nbsp;</td>
		<td class="actions">
